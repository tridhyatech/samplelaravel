...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" method="post" action="{{url('/admin/projects/update/'.$projectDetails['id'])}}" name="project_update" id="project_update">
                    @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="estimated_hours" id="estimated_hours" value="{{ old('estimated_hours') != '' ? old('estimated_hours') : $projectDetails['estimated_hours']}}" class="form-control" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="project_end_date" id="project_end_date" value="{{ old('project_end_date') != '' ? old('project_end_date') : $projectDetails['project_end_date']}}" class="form-control" required />
