...
<div class="page-wrapper">
                ...
                <div class="text-left">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('/admin/projects')}}">Project Management</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" method="post" action="{{url('/admin/projects/store')}}" name="user_create" id="user_create">
                    @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="project_name" id="project_name" value="{{ old('project_name') }}" class="form-control" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="select2 form-control custom-select" name="account_manager" id="account_manager" style="width: 100%; height:36px;" required>
                                        ...
                                        <option value="{{$accountManager['id']}}" {{ old('account_manager') == 
                                        $accountManager['id'] ? 'selected' : ''}}>{{$accountManager['first_name'].' '.$accountManager['last_name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> 
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="select2 form-control custom-select" name="project_manager" id="project_manager" style="width: 100%; height:36px;" required>
                                        ...
                                        <option value="{{$projectManager['id']}}" {{ old('project_manager') == 
                                        $projectManager['id'] ? 'selected' : ''}}>{{$projectManager['first_name'].' '.$projectManager['last_name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> 
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="estimated_hours" id="estimated_hours" value="{{ old('estimated_hours') }}" class="form-control" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="select2 form-control custom-select" name="project_type" id="project_type" style="width: 100%; height:36px;" required>
                                        ...
                                        <option value="{{$type['id']}}" {{ old('project_type') == 
                                        $type['id'] ? 'selected' : ''}}>{{$type['project_type_name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>  
                            <div class="form-group row">
                                <label for="project_start_date" class="col-sm-3 text-right control-label col-form-label">Start Date</label>
                                <div class="col-sm-9">
                                    <input type="text" name="project_start_date" id="project_start_date" value="{{ old('project_start_date') }}" class="form-control" required />
                            ...
                            <div class="form-group row">
                                <label for="project_end_date" class="col-sm-3 text-right control-label col-form-label">End Date</label>
                                <div class="col-sm-9">
                                    <input type="text" name="project_end_date" id="project_end_date" value="{{ old('project_end_date') }}" class="form-control" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select name="project_status" id="project_status" class="select2 form-control custom-select" style="width: 100%; height:36px;" required>
                                        ...
                                        <option value="{{$key}}" {{ old('project_status') == 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="select2 form-control custom-select" multiple="" name="project_users[]" id="project_users" style="width: 100%; height:100px;" required>
                                        ...
                                        <option value="{{$projectUser['id']}}" {{ (collect(old('project_users'))->contains($projectUser['id'])) ? 'selected':'' }}>{{$projectUser['first_name'].' '.$projectUser['last_name']}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="border-top">
                            <div class="card-body">
                                ...
                                <a href="{{url('/admin/projects')}}"><button type="button" value="Cancel" class="btn btn-secondary">Cancel</button></a>
                            </div>
                        </div>
                    </form>
                </div>
