...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" method="post" action="{{url('/pms/cr/update/'.$crDetails['id'])}}" name="cr_create" id="cr_create">
                    @csrf
                        <div class="card-body">
                            <h4 class="card-title">Edit Change Request</h4>
                            <div class="form-group row">
                                <label for="title" class="col-sm-3 text-right control-label col-form-label">Title</label>
                                <div class="col-sm-9">
                                    <input type="text" name="title" id="title" value="{{ $crDetails['title'] }}" class="form-control" required />
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="estimated_hours" id="estimated_hours" value="{{ $crDetails['estimated_hours'] }}" class="form-control" onkeypress="return isNumberKey(event)" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select name="status" id="status" class="select2 form-control custom-select" style="width: 100%; height:36px;" required>
                                        ...
                                        <option value="{{$key}}" {{ $crDetails['status'] != '' ? ($crDetails['status'] == $key ? 'selected' : '') : ''}}>{{$value}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="border-top">
                            <div class="card-body">
                                ...
                                <a href="{{url('/pms/cr/all_cr')}}"><button type="button" value="Cancel" class="btn btn-secondary">Cancel</button></a>
                            </div>
                        </div>
                    </form>
                </div>
