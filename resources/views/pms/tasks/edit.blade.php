...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" method="post" action="{{url('/pms/tasks/update/'.$taskDetails['id'])}}" name="project_update" id="project_update">
                    @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="task_hours" id="task_hours" value="{{ old('task_hours') != '' ? old('task_hours') : $taskDetails['task_hours']}}" onkeypress="return isNumberKey(event)" class="form-control" required />
