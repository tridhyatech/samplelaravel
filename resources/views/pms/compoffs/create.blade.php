...
<div class="page-wrapper">
                ...
                <div class="text-left">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('/pms/compoffrequests')}}">Comp-off Requests</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" method="post" action="{{url('/pms/compoffs/store')}}" name="compoff_create" id="compoff_create">
                    @csrf
                        <div class="card-body">
                            <h4 class="card-title">Add Comp-off Request</h4>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="select2 form-control custom-select" name="approver_id" id="approver_id" style="width: 100%; height:36px;" disabled="" >
                                        ...
                                        <option value="{{$reportingTo['id']}}" 
                                                {{ $userDetails['reporting_to'] == $reportingTo['id'] ? 'selected' : ''}}>{{$reportingTo['first_name'].' '.$reportingTo['last_name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> 
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="compoff_start_date" id="compoff_start_date" value="{{ old('compoff_start_date') }}" class="form-control" required />
                            ...
                            <div class="form-group row">
                                <label for="compoff_description" class="col-sm-3 text-right control-label col-form-label">Comp-off Description</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="compoff_description" id="compoff_description" required>{{ old('compoff_description') }}</textarea>
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 text-right control-label col-form-label">Comp-off Status</label>
                                <div class="col-md-9">
                                    <select name="compoff_status" id="compoff_status" class="select2 form-control custom-select" style="width: 100%; height:36px;" disabled="" >
                                        <option value="">Select Comp-off Status</option>
                        ...
                        <div class="border-top">
                            <div class="card-body">
                                ...
                                <a href="{{url('/pms/compoffrequests')}}"><button type="button" value="Cancel" class="btn btn-secondary">Cancel</button></a>
                            </div>
                        </div>
                    </form>
                </div>
