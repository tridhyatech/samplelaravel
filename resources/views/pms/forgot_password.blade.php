        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginbox">
                    ...
                    @endif        
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" method="post" id="loginform" action="{{url('pms/forgotpassword')}}">
                        @csrf
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        */
                                        ?>                    
                                        <input type="submit" value="Send Password" href="index.html" class="btn btn-success float-right" />
                                    </div>
                                </div>
                            </div>
                        </div>
