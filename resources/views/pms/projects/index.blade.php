...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" method="post" action="{{url('/pms/projects')}}" name="search_project" id="search_project">
                    @csrf
                        <div class="card-body">
                            ...
                            <table id="project_listing" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                      ...
                                      <th>Estimation</th>
                                      <th>Logged Hours</th>
                  										@permission('projects.edit|projects.delete')
                                      <th>Action</th>
                                      @endpermission
                                    </tr>
                                </thead>
                                ...
                                @if (count($projectsData)>0)  
                                  ...
                                  <tr>
                                    ...
                                    <td>{{(new \App\Helpers\CommonHelper)->displayTaskTime($project['estimated_hours'])}}</td>
