...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" method="post" action="{{url('/pms/projects/store')}}" name="user_create" id="user_create">
                    @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="estimated_hours" id="estimated_hours" value="{{ old('estimated_hours') }}" onkeypress="return isNumberKey(event)" class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="project_end_date" id="project_end_date" value="{{ old('project_end_date') }}" class="form-control" />
...
<script type="text/javascript">
  $(function(){
    ...
    $("#project_type").change(function(){
        var PrjctType = $('#project_type').find(":selected").val();
        if(PrjctType == 1){
            $("#estimated_hours").attr("required","required" );
            $("#project_end_date").attr("required","required" );
        }else{
            $("#estimated_hours").removeAttr( "required" );
            $("#project_end_date").removeAttr( "required" );
        }
    }); 
  });
</script>
